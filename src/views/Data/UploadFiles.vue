<template>
    <div class="d-flex justify-space-around"
        ...
        <div style="border-right: 0.5px solid #e0e0e0; width: 19%">
            <v-list-item>
                <v-icon @click="previousPage()"
                        class="mdi mdi-chevron-left mdi-24px"></v-icon>
                <v-list-item-content>
                    <v-list-item-title> ***航空数据 </v-list-item-title>
                </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
            <v-list-item v-for="item in filesName"
                         :key="item">
                <!-- <v-list-item-icon>
        ...
        <v-card width="81%"
            ...
            <v-card class="d-flex justify-space-around align-center"
                ...
                <v-col class="d-flex justify-center align-items-center"
                       cols="5">
    ...
    methods: {
        ...
        async uploadFile () {
            ...
            if (this.filesName.length != 0) {
                ...
                await uloadFilesApi(formData).then((res) => {
                    this.files = []
                })
            }
        },
